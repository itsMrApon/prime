						...
						<div class="in-service-details-text-area">
							<div class="in-service-title-text">
								<div class="in-section-title-2 headline">
									...
									<h2>{{ $inc_service['name'] }} </h2>
								</div>
								<div class="in-service-title-desc">
									{{$inc_service['discrption']}}
								</div>
							</div>
							<div class="in-service-details-list ul-li-block">
								<ul>
									<li>{{$inc_service['qoute1']}}</li>
									<li>{{$inc_service['qoute2']}}</li>
									<li>{{$inc_service['qoute3']}}</li>
									<li>{{$inc_service['qoute4']}}</li>
									<li>{{$inc_service['qoute5']}}</li>
								</ul>
							</div>
						</div>
					</div>
