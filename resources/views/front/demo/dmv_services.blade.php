...
@section('title', 'insurance_services')
@section('body')
					...
					<div class="col-lg-7">
						<div class="in-service-slider-area-5">
							<div class="in-service-vertical-slider">
								{{--  --}}
								@unless(count($inc_services) == 0)
								@foreach($inc_services as $inc_service )
								{{--  --}}
								<div class="in-service-item-slide">
									<div class="in-service-item-5 d-flex align-items-center">
										...
										<div class="inner-text headline pera-content">
											<h3><a href="{{$inc_service->id}}"> {{$inc_service->name}} </a></h3>
											{{-- <h3><a href="inc_service/{{$inc_service->route}}"> {{$inc_service->name}} </a></h3>
											<p> {{$inc_service->moto}} </p> --}}
											<a class="more-btn" href="/front/services/inc_services/{{$inc_service->id}}">Read More <i class="far fa-long-arrow-right"></i></a>
										</div>
									</div>
								</div>
								{{--  --}}
