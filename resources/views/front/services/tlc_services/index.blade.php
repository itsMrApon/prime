		...
		<div class="in-breadcrumb-content position-relative"  data-background="assets/img/bg/error-bg.jpeg">
			...
			<div class="container">
				<div class="in-breadcrumb-title-content position-relative headline ul-li">
					...
					<ul>
						<li><a href="/">Home</a></li>
						<li class="active-page">TLC Services </li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="col-lg-7">
						<div class="in-service-slider-area-5">
							<div class="in-service-vertical-slider">
								{{--  --}}
								@unless(count($tlc_services) == 0)
								@foreach($tlc_services as $tlc_service )
								{{--  --}}
								<div class="in-service-item-slide">
									<div class="in-service-item-5 d-flex align-items-center">
										...
										<div class="inner-text headline pera-content">
											<h3><a href="{{$tlc_service->id}}"> {{$tlc_service->name}} </a></h3>
											{{-- <h3><a href="tlc_service/{{$tlc_service->route}}"> {{$tlc_service->name}} </a></h3>
											<p> {{$tlc_service->moto}} </p> --}}
											<a class="more-btn" href="/front/services/tlc_services/{{$tlc_service->id}}">Read More <i class="far fa-long-arrow-right"></i></a>
										</div>
									</div>
								</div>
								{{--  --}}
								@endforeach
								@else
								<p>No insurance services found</p>
								@endunless
								{{--  --}}
							</div>
						</div>
